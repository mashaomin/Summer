...
namespace TrueSync
{
    ...
    public partial struct FP : IEquatable<FP>, IComparable<FP>
    {
        ...
        public static readonly FP V90 = FP.NewIntFP(90);
        public static readonly FP V270 = FP.NewIntFP(270);
        public static readonly FP V180 = FP.NewIntFP(180);
        public static readonly FP V360 = FP.NewIntFP(360);
        ...
        public static readonly FP Deg2Rad = Pi / NewIntFP(180);
        public static readonly FP HalfDeg2Rad = Deg2Rad * Half;

        public static readonly FP Rad2Deg = NewIntFP(180) / Pi;
        ...
        public static FP NewIntFP(int value)
        {
            FP fp = new FP();
            fp._serializedValue = value * ONE;
            return fp;
